...
* Default when condition: `editorTextFocus && !editorReadonly && config.no-indent-newline.before.enable`
...
* Default when condition: `editorTextFocus && !editorReadonly && config.no-indent-newline.up.enable`
...
* Default when condition: `editorTextFocus && !editorReadonly && config.no-indent-newline.down.enable`
...
* Default when condition: `editorTextFocus && !editorReadonly && config.no-indent-newline.after.enable`
